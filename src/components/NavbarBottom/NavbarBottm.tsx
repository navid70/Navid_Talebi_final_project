    ...
    return (
        ...
        <div className="desc-nav-bottom  d-flex d-lg-none px-4">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                <NavLink className="d-flex flex-column align-items-center justify-content-center"
                         activeClassName="selected" to="/categoryMobile">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                <NavLink className="d-flex flex-column align-items-center justify-content-center"
                         activeClassName="selected" to="/cart">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
                <NavLink className="d-flex flex-column align-items-center" activeClassName="selected" to="/register">
