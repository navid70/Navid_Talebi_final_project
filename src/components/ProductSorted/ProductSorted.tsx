...
const ProductStored: React.FC<IProductSorted> = ({
                                                     handleSortLowest,
                                                     handleHighestPrice,
                                                     handleHighestDiscountPrice,
                                                     handleDefaultSort
                                                 }) => {
    return (
        <div className="sidebar-sorted mb-4 d-flex align-items-center">
            <span className="me-3">بر اساس: </span>
            <ul className="d-flex align-items-center justify-content-evenly m-0">
                <li onClick={() => handleDefaultSort()} className="active-sorted">جدیدترین</li>
